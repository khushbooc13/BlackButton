...
if(isset($_SESSION['cid']) && $_SESSION['cid']!=0 && $_SESSION['pid']==1)
{
    ...
    <div id="container">
                ...
                <div id="general">
                    ...
                    <ul class="navigation widget">
                       <li><a href="index.php" title=""><i class="icon-home"></i>Dashboard</a></li>
						...
						<li class="active"><a href="#"><i class="icon-home"></i>Add Sensor To Element</a></li>
						<li><a href="charts.php"><i class="icon-home"></i>Get Sensor Data</a></li>
                </div>
        ...
        <!-- Content -->
        <div id="content">
            <form id="validate" class="form-horizontal" method="post" action="scripts/addSensor.php" >
            <div class="widget">
                <div class="navbar">
            ...
            <div class="well row-fluid">
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select name="location" onchange="showElements(this.value)" data-placeholder="Choose a Location...">
                            <option value=""></option>
                            <?php
                ...
                <div class="control-group">
                    ...
                    <div class="controls" >
                        <input type="number" class="span6" placeholder="No Of Sensor" name="sensorcount" min="1" id="sensorcount" onblur="ins();" required />
                    </div>
                </div>
                <div class="control-group">
			...
			function showElements(str) 
{
    ...
    else 
    {
        ...
        xmlhttp.open("GET","scripts/getElement.php?lid="+str,true);
        xmlhttp.send();
    }
}
