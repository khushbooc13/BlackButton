...
<li ><a href="mainindex.php" title=""><i class="icon-home"></i>Dashboard</a></li>
					...
					<li class="active"><a href="registrationform.php" title="" class="expand"><i class="icon-reorder"></i>Add User To Existing Sites</a>
                    </li>
		...
		<div id="content">
			...
			<form id="validate" class="form-horizontal" method="post" action="scripts/primaryinsert.php" >
	                <fieldset>

	                    <!-- Form validation -->
	                    <div class="widget">
	                        <div class="navbar"><div class="navbar-inner"><h6>Create New User</h6></div></div>
	                    	<div class="well row-fluid">
	                            ...
	                            <div class="control-group">
	                                ...
	                                <div class="controls">
	                                    <input type="text" value="" class="span6" placeholder="Email Address" name="emailValid" id="emailValid" />
	                                </div>
	                            </div>
	                            ...
	                            <div class="control-group">
	                                ...
	                                <div class="controls">
	                                    <input type="password" class="span6 tip" name="password1" id="password1"  placeholder="Atleast 1 number, uppercase letter, lowercase letter is required" data-original-title="Password must be 8 characters long" />
	                                </div>
	                            </div>
	                            ...
	                            <div class="control-group">
	                                ...
	                                <div class="controls" >
	                                    <input type="text" class="span6" placeholder="Phone Number" name="numsValid" id="numsValid"  />
	                                </div>
	                            </div>
	                            ...
	                            <div class="control-group">
	                                ...
	                                <div class="controls">
	                                    <select name="select2" id="select2" class="styled" data-prompt-position="topLeft:-1,-5" >
	                                    		<option value=""></option>
										   <?php	

										   			$sql = 'SELECT cid,name from companydetails';
