    ...
    <div class="login">
        <div class="navbar">
            <div class="navbar-inner">
                <h6><i class="icon-user"></i>Forgot Password Page</h6>
                </div>
        </div>
        <div class="well">
            <form action="scripts/mailpassword.php" method="post" class="row-fluid">
                <div class="control-group">
                    <label class="control-label">Email Id</label>
                    <div class="controls"><input class="span12" type="text" name="email" /></div>
                </div>
                
                <div class="login-btn"><input type="submit" value="Submit" class="btn btn-danger btn-block" /></div>
            </form>
        </div>
    </div>
    <!-- /login block -->
